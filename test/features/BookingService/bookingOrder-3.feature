Feature: Booking Service - Success Booking Service Without add New Motor
        ...
        @id:1 @FM-1230 @FM-1231 @FM-1231 @agrdinia7257 @verifyThanksBooking @skeleton @skip()
        Scenario: [MOBILE] User can booking service step-1 for existing vehicle successfully 
